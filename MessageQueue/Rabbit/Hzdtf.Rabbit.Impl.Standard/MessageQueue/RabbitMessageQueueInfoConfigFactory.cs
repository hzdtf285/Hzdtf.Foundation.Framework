...
namespace Hzdtf.Rabbit.Impl.Standard.MessageQueue
{
    ...
    public class RabbitMessageQueueInfoConfigFactory : IMessageQueueInfoFactory
    {
        ...
        public MessageQueueInfo Create(string queueOrOtherIdentify = null, IDictionary<string, string> extend = null)
        {
            return MessageQueueReader.Reader(queueOrOtherIdentify, extend);
        }
