...
namespace Hzdtf.BasicFunction.Persistence.MySql.Standard
{
    ...
    /// </summary>
    [Inject]
    public partial class UserMenuFunctionPersistence : MySqlDapperBase<UserMenuFunctionInfo>, IUserMenuFunctionPersistence
    {
        /// <summary>
        /// 表名
        /// </summary>
        protected override string Table => "user_menu_function";
