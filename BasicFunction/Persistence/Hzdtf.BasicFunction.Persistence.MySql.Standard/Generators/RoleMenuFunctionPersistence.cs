...
namespace Hzdtf.BasicFunction.Persistence.MySql.Standard
{
    ...
    /// </summary>
    [Inject]
    public partial class RoleMenuFunctionPersistence : MySqlDapperBase<RoleMenuFunctionInfo>, IRoleMenuFunctionPersistence
    {
        /// <summary>
        /// 表名
        /// </summary>
        protected override string Table => "role_menu_function";
