...
namespace Hzdtf.WorkFlow.Service.Impl.Standard
{
    ...
    public partial class SendFlowRouteService
    {
        ...
        public virtual ReturnInfo<IList<SendFlowRouteInfo>> QueryByFlowCensorshipId([DisplayName2("流程关卡ID"), Id] int flowCensorshipId, string connectionId = null, BasicUserInfo<int> currUser = null)
        {
        ...
        /// <param name="currUser">当前用户</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<IList<SendFlowRouteInfo>> QueryByFlowCensorshipIds(int[] flowCensorshipIds, string connectionId = null, BasicUserInfo<int> currUser = null)
        {
            return ExecReturnFuncAndConnectionId<IList<SendFlowRouteInfo>>((reInfo, connId) =>
            {
