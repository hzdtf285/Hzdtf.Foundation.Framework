...
namespace Hzdtf.WorkFlow.Service.Impl.Standard
{
    ...
    public partial class WorkflowHandleService
    {
        ...
        [Auth]
        public virtual ReturnInfo<bool> ModifyToReadedById([DisplayName2("ID"), Id] int id, string connectionId = null)
        {
            return ExecReturnFuncAndConnectionId<bool>((reInfo, connId) =>
            {
                ...
                if (wh.HandlerId != UserTool.CurrUser.Id)
                {
        ...
        /// <returns>返回信息</returns>
        [Auth]
        public virtual ReturnInfo<bool> ExistsAuditAndUnhandleByHandleId([DisplayName2("处理人ID"), Id] int handlerId, string connectionId = null)
        {
        ...
        /// <returns>返回信息</returns>
        [Auth]
        public virtual ReturnInfo<bool[]> ExistsAuditAndUnhandleByHandleIds([DisplayName2("处理人ID集合"), ArrayNotEmpty] int[] handlerIds, string connectionId = null)
        {
            return ExecReturnFuncAndConnectionId<bool[]>((reInfo, connId) =>
            {
        ...
        /// <returns>返回信息</returns>
        [Auth]
        public virtual ReturnInfo<WorkflowHandleInfo> FindByWorkflowIdAndFlowCensorshipIdAndHandlerId([DisplayName2("工作流ID"), Id] int workflowId, [DisplayName2("流程关卡ID"), Id] int flowCensorshipId, [DisplayName2("处理人ID"), Id] int handleId, string connectionId = null)
        {
