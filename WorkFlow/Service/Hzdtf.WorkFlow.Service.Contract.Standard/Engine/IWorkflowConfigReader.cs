...
namespace Hzdtf.WorkFlow.Service.Contract.Standard.Engine
{
    ...
    public partial interface IWorkflowConfigReader
    {
        ...
        ReturnInfo<WorkflowDefineInfo> ReaderAllConfig(int workflowDefineId, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<WorkflowDefineInfo> ReaderAllConfig(string workflowCode, string connectionId = null);
    }
}
