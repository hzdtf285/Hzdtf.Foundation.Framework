...
namespace Hzdtf.WorkFlow.Service.Contract.Standard.Engine.Form
{
    ...
    public partial interface IFormRemove
    {
        ...
        ReturnInfo<bool> BeforeExecFlow(WorkflowInfo workflow, RemoveType removeType, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<bool> AfterExecFlow(WorkflowInfo workflow, RemoveType removeType, bool isSuccess, string connectionId = null);
    }
}
