...
namespace Hzdtf.WorkFlow.Service.Contract.Standard
{
    ...
    public partial interface IReturnFlowRouteService : IReturnFlowRouteServiceAsync
    {
        ...
        ReturnInfo<IList<ReturnFlowRouteInfo>> QueryByFlowCensorshipId(int flowCensorshipId, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<IList<ReturnFlowRouteInfo>> QueryByFlowCensorshipIds(int[] flowCensorshipIds, string connectionId = null);
    }
}
