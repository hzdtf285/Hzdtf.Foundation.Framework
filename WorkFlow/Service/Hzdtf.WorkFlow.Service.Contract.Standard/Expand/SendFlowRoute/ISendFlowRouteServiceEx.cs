...
namespace Hzdtf.WorkFlow.Service.Contract.Standard
{
    ...
    public partial interface ISendFlowRouteService : ISendFlowRouteServiceAsync
    {
        ...
        ReturnInfo<IList<SendFlowRouteInfo>> QueryByFlowCensorshipId(int flowCensorshipId, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<IList<SendFlowRouteInfo>> QueryByFlowCensorshipIds(int[] flowCensorshipIds, string connectionId = null);
    }
}
