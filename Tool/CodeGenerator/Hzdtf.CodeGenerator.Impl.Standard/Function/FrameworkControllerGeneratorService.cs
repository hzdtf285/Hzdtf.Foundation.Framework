...
namespace Hzdtf.CodeGenerator.Impl.Standard.Function
{
    ...
    /// </summary>
    [Inject]
    public class FrameworkControllerGeneratorService : FunctionGeneratorBase
    { 
        /// <summary>
        /// 类模板
        /// </summary>
        ...
        private static string ClassTemplate
        {
            get
            {
                ...
                {
                    classTemplate = $"{AppContext.BaseDirectory}CodeTemplate\\Controller\\Framework\\classTemplate.txt".ReaderFileContent();
                }
        ...
        protected override string[] BuilderCodeTexts(TableInfo table, string namespacePfx, string type, out string[] fileNames)
        {
            ...
            string desc = string.IsNullOrWhiteSpace(basicName) ? basicName : table.Description;
            return new string[] 
            {
                ClassTemplate
        ...
        protected override string[] SubFolders() => new string[] { "FrameworkController" };
    }
}
